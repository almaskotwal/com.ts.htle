...
public class TestNGDataDrivenConcepts {
	...
	@Test(dataProvider ="getData" ) // DataProvider's method name
	...
	@DataProvider() // DataProvider method is 2D array which gets data from an Excel sheet
	public Object[][] getData() {
		Object data[][] = getExcelData();
		return data;
	}

	//this method used Apache POI, which has interfaces such as WorkBook, Sheet
	public static Object[][] getExcelData() {
		...
		try {
			FileInputStream file = new FileInputStream(excelPath); // locates the file
